...
吃正餐去 RI，吃快餐去 In'SNACK，吃披萨去 Olivier，吃早餐去 Point A
[参考](https://www.insa-lyon.fr/fr/restauration)
...
![induction logo](../assets/induction_logo.png){:height="10%" width="10%"}
...
大三大四可以申请单人间，可以在 C、D、E、F、G/J、H、I、M(Megellan) 中选。

INSA 的所有宿舍水电暖气全包，网费另付。网络提供商由 Quantic Telecom 独家提供，年费 120€，单独一个月 15€。


[参考](https://www.insa-lyon.fr/fr/logement)
